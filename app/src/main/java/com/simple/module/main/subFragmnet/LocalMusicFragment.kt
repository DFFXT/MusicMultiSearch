...
class LocalMusicFragment : BaseFragment() {
    ...
    private val adapter =
        BaseSingleAdapter<Music>(R.layout.item_search_result) { holder, index, item ->
    ...
    override fun initView() {
        ...
        PermissionUtil.requestIOPermission(mActivity, REQUEST_PERMISSION_CODE) { allGranted ->
            if (!allGranted) return@requestIOPermission
